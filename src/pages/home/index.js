...
const HomePage = () => {
  ...
  /* Inside the useEffect() hook, we’ve passed type to our 
  API’s getPets method which fetches pets of the specified type 
    ...
    <div className="page">
      ...
      {data.length ? (
        <div className="grid">
          {data.map((animal) => (
            <Link
              to={`/${animal.type.toLowerCase()}/${animal.id}`} className="pet">
              <article>
